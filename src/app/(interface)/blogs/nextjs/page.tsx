...
export const metadata: Metadata = {
  title: 'Next.js for Beginners: Build Fast, SEO-Friendly Web Apps | MyApp',
  ...
  keywords: ['Next.js', 'React framework', 'Next.js tutorial', 'Server-Side Rendering', 'Static Site Generation', 'beginner Next.js', 'Next.js 14'],
  openGraph: {
    title: 'Next.js for Beginners: Build Fast, SEO-Friendly Web Apps',
    description: 'Discover Next.js’s power with this beginner-friendly guide, featuring Server-Side Rendering, Static Site Generation, and Node.js code examples.',
    url: 'https://kunalshroff.vercel.app/blogs/nextjs',
    type: 'article',
    // images: [
    //   {
  ...
  twitter: {
    ...
    title: 'Next.js for Beginners: Build Fast, SEO-Friendly Web Apps',
    description: 'Learn Next.js with this beginner-friendly guide, featuring code examples and real-world use cases.',
    // images: ['https://kunalshroff.vercel.app/images/nextjs-blog-og.jpg'],
  },
  alternates: {
    canonical: 'https://kunalshroff.vercel.app/blogs/nextjs',
  },
};
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 2,
          name: 'Next.js Blog',
          item: 'https://kunalshroff.vercel.app/blogs/nextjs',
        },
      ],
    },
  ],
...
//   return {
//     props: {}, // Static page, no dynamic data needed
//   };
// }